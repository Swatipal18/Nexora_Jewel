...
export default function Router() {
  const routes = createHashRouter([
    {
      path: "/",
      element: <Navigate to="/admin" replace />, // Redirect home to admin
    },
    {
      path: "/login",
      element: <Login />, // Login route moved to /login
    },
    {
      path: "/",
      element: <App />,
    ...
    {
      path: "*",
      element: <Navigate to="/admin" replace />, // Redirect all unknown routes to admin
    },
  ]);
